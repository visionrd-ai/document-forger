...
from .utils import set_tesseract_cmd, DEFAULT_PROBABILITY, TOTAL_DOCUMENTS, CONFIDENCE_THRESHOLD, DESKEW_IMAGE, MAX_TRIES, FORMAT
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--format', type=str, default=FORMAT, help='Output format of the image.')
    ...
    document_forgeries = process_document(args.image_path, args.output_dir, args.probability, args.total_documents \
        , args.confidence_threshold, args.deskew_image, args.max_tries, args.format)
